...
```
*Generate all symmetry-equivalent crystal directions and plane normals with pr...*
...
```
*Convert Cartesian coordinates to spherical coordinates (polar and azimuthal a...*
